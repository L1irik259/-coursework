        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHelpRequested = table.Column<bool>(type: "bit", nullable: false),
                    HelpRequestedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeadlineExtended = table.Column<bool>(type: "bit", nullable: false),
                    ExtendedDeadline = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExtensionAgreementNote = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddedByManagerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestConsultants_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "RequestId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestConsultants_Users_AddedByManagerId",
                        column: x => x.AddedByManagerId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RequestConsultants_Users_SpecialistId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "RequestStatusId", "Name" },
                values: new object[,]
                {
                    { 1, "В ожидании" },
                    { 2, "В работе" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "QrCodeFormUrl", "https://forms.google.com/your-form-link-here" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestConsultants_AddedByManagerId",
                table: "RequestConsultants",
                column: "AddedByManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestConsultants_RequestId",
                table: "RequestConsultants",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestConsultants_SpecialistId",
                table: "RequestConsultants",
                column: "SpecialistId");
